...
const SHOES = [
  ...
  { n: "03", brand: "Adidas",      model: "Ultraboost 26",          cat: "Daily Trainer", price: 190, weight: 310, drop: 6,  colors: ["#111111", "#f4f4f4", "#d1281f"], photo: "assets/products/shoe-03-adidas-ultraboost26.png" },
  ...
  { n: "06", brand: "New Balance", model: "FuelCell SC Elite v5",   cat: "Race Day",      price: 225, weight: 198, drop: 6,  colors: ["#e0432b", "#2f6fed"], photo: "assets/products/shoe-06-nb-fuelcell.png" },
  { n: "07", brand: "Asics",       model: "Gel-Nimbus 27",          cat: "Max Cushion",   price: 160, weight: 295, drop: 8,  colors: ["#1c2b4a", "#f28ba8"], photo: "assets/products/shoe-07-asics-nimbus27.png" },
  ...
  { n: "10", brand: "Hoka",        model: "Rocket X 3",             cat: "Race Day",      price: 200, weight: 213, drop: 5,  colors: ["#e8622c", "#111111"], photo: "assets/products/shoe-10-hoka-rocketx3.png" },
  { n: "11", brand: "Brooks",      model: "Ghost 17",               cat: "Daily Trainer", price: 140, weight: 269, drop: 12, colors: ["#4a4f57", "#1f6f6a"], photo: "assets/products/shoe-11-brooks-ghost17.png" },
